...
output "IP_address3_server2" {
  value = "${ibm_compute_vm_instance.server2.secondary_ip_addresses.0}"
}
...
output "IP_address3_server3" {
  value = "${ibm_compute_vm_instance.server3.secondary_ip_addresses.0}"
}
